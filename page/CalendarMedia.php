...
<!-- Button 1, "glyphicon glyphicon-chevron-down"- make the little dropdown arrow -->
                <div class="btn-group" id="nav-item">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" style="font-size:1.4em;">
